...
const Button = ({ children, disabled, to, type, onClick }) => {
  ...
  if (onClick) return (
    <button disabled={disabled} className={styles[type]} type={type} onClick={onClick}>
      {children}
    </button>
  );
